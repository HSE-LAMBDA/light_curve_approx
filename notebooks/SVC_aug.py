...
class SupportVectorClassificationAugmentation(object):
    ...
    def fit(self, t, flux, flux_err, passband):
        ...
        self.y_scaler = LabelEncoder().fit(flux.reshape((-1, 1)))
        y_ss = self.y_scaler.transform(flux.reshape((-1, 1)))
        
        self.reg = SVC(kernel='rbf', gamma='auto', decision_function_shape='ovr', random_state=42)
